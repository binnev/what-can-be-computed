...
def testGraphAddEdge():
    testvals = [
        ...
        (
            ("b,a,3 a,a,4 a,ccc,5 b,d,6",),
            (Edge(["ccc", "a"]), 9),
            "ccc,a,9 b,a,3 a,a,4 a,ccc,5 b,d,6",
        ),
        (
            ("b,a,3 a,a,4 a,ccc,5 b,d,6", True, False),
            (Edge(["b", "ccc"]), 9),
            "b,ccc,9 b,a,3 a,a,4 a,ccc,5 b,d,6",
        ),
